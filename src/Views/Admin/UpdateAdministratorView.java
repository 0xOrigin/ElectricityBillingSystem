...
public class UpdateAdministratorView extends javax.swing.JFrame implements View{
    ...
    private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
        ...
        this.controller.updateAdmin(fields,values,this.controller.getLoggedInID());
    ...
    private void AddressFieldAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_AddressFieldAncestorAdded
        ...
        this.oldAddress =(String) this.controller.getInfo(Arrays.asList(Column.Address), this.controller.getLoggedInID()).get(Column.Address);
    ...
    private void EmailFieldAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_EmailFieldAncestorAdded
        this.oldEmail =(String) this.controller.getInfo(Arrays.asList(Column.Email), this.controller.getLoggedInID()).get(Column.Email);
    ...
    private void PhoneNumberFieldAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_PhoneNumberFieldAncestorAdded
        this.oldPhone =(String) this.controller.getInfo(Arrays.asList(Column.PhoneNumber), this.controller.getLoggedInID()).get(Column.PhoneNumber);
    ...
    private void RoleFieldAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_RoleFieldAncestorAdded
        this.fillRole();
        this.oldRole =(String) this.controller.getInfo(Arrays.asList(Column.Role), this.controller.getLoggedInID()).get(Column.Role);
